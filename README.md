...
| Модель                                 | Recall@10 | NDCG@10 | Coverage@10 | CosineSim@10 |
|----------------------------------------|-----------|---------|--------------|---------------|
| **Baseline**                           | **3.700**     | **7.810**   | **2.570**        | **0.000**         |
| MostPopular                            | 1.530     | 2.600   | 0.000        | 46.070        |
| NewItemsLastNDays                      | 0.660     | 1.520   | 0.000        | 45.850        |
| ALS                                    | 1.890     | 4.140   | 0.180        | 61.280        |
| BM25                                   | 3.360     | 6.330   | 9.460        | 64.190        |
| ItemKNN                                | 4.307     | 8.100   | 2.620        | 63.060        |
| BPR                                    | 0.960     | 2.430   | 4.460        | 64.350        |
| RandomWalkWithRestart                  | 5.600     | 10.580  | 5.650        | 64.460        |
| KMeansEmbedding                        | 2.660     | 4.350   | 6.520        | 69.226        |
| **HybridModel**                            | **8.520**     | **14.490**  | **5.415**        | **66.570**        |
| HybridModel + Filt.                    | 2.940     | 6.040   | 4.310        | 65.080        |
| HybridModel + Filt. + Diver.           | 2.620     | 5.690   | 4.150        | 63.860        |
| **HybridModel + Filt. + Diver. + EG**      | **2.350**     | **5.290**   | **3.860**        | **60.590**        |
