...
**ItemKNN** 
Модель, основанная на поиске соседей среди айтемов. Для каждого трека находятся наиболее похожие по поведению пользователей другие треки, и рекомендации формируются на основе этих похожих айтемов. Простая и эффективная модель, хорошо работающая на плотных взаимодействиях.
