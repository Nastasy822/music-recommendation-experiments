...
Недавно Яндекс опубликовал крупный датасет для построения музыкальных рекомендаций — YAMaDa,
основанный на реальных пользовательских логах и подробно описанный в исследовании.

<p align="left"> <a href="https://huggingface.co/datasets/yandex/yambda"> <img src="https://img.shields.io/badge/HuggingFace-YAMaDa-ffcc00?logo=huggingface&logoColor=black" /> </a> <a href="https://www.arxiv.org/pdf/2505.22238"> <img src="https://img.shields.io/badge/arXiv-2505.22238-b31b1b?logo=arxiv&logoColor=white" /> </a> <a href="https://yandex.com"> <img src="https://img.shields.io/badge/Yandex-Research-red?logo=yandex&logoColor=white" /> </a> </p>

Это полноценный индустриальный датасет, созданный для развития и популяризации современных подходов к рекомендательным системам.


Поскольку рекомендации сегодня — один из ключевых инструментов цифровых сервисов, а реального опыта работы с такими системами у меня не было, появление этого датасета стало отличным поводом глубже погрузиться в область.
