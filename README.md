...
### 1. **Recall@K**
При музыкальных рекомендациях важно предложить пользователю как можно больше релевантных треков. Даже если среди рекомендаций окажутся «ошибки», пользователь всё равно сможет найти что-то подходящее. Precision в данном случае хуже подходит — нам важнее *полнота*, а не строгое избегание ошибок.

Recall@K показывает, какую часть всех релевантных треков система нашла в топ-K рекомендаций.
