...
> Формат Y менялся с улучшением системы. Сначала цель была просто предсказать любое взаимодействие пользователя с произведением. Затем уже только прослушанные песни до конца, и в конце лайки.
...
<img src="./img/recall10.png" width="600"/>

### 📊 NDCG@10

<img src="./img/ndcg10.png" width="600"/>
